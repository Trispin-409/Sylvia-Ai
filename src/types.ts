...
export interface ApprovalRequest {
  ...
  metadata?: Record<string, unknown>;
  /** Synthetic ADK request-confirmation function-call id used to resume HITL. */
  confirmationCallId?: string;
  /** ADK confirmation function name; normally adk_request_confirmation. */
  confirmationName?: string;
  /** Original tool call id that requested confirmation. */
  originalFunctionCallId?: string;
  /** Optional payload generated by the gated tool. */
